  ...
  return (
    <section id="projectSection">
      ...
      <Display
        ...
        p2={`The course was fun, but quite demanding, the best thing I got out of it was for sure the different projects I made, you can find them by checking the certificate either by pressing the button below or the image ${document.body.clientWidth <= 700 ? "above." : "on the left."}`}
